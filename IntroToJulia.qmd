...
Try a bunch of comparisons of values using the above. These are called _Boolean expressions_.
...
Tuples are useful for efficiency--because they are not mutable, Julia can store and use them in a more efficient way than arrays. They are also used when calling functions (we'll explore this later).
