...
We now have all the essential tools for writing programs to do all sorts of neat things. One thing we haven't explored much yet is how to important a really big dataset into Julia and then do some neat analyses on it. We'll look at an example of this on the next page.