...
Let's define some _x_ values and _y_ values of points, and then plot them by connecting those points with lines:
...
Now that we have a good understanding of the key elements of programming and have some plotting tools, we can work towards building simulations and conducting data analysis. First, let's learn some more details about how numbers are stored in a computer, and how large amounts of data can be stored efficiently in arrays and data frames.
