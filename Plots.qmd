...
```{julia}
annotate!(-3, 10, "Here's some DIFFERENT TEXT", :left)
```
...
Now that we have a good understanding of the key elements of programming and have some plotting tools, let's build an actual simulation! 