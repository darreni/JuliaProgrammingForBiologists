...
[JuliaImages](https://juliaimages.org): image processing and machine vision.

[Tidier](https://tidierorg.github.io/Tidier.jl): if you are used to using the "Tidyverse" in R (e.g. ggplot, dplyr, tidyr), this is "a data analysis package inspired by R's tidyverse and crafted specifically for Julia." (Note however that using these approaches may not be the best way to gain insight into underlying syntax and logic of Julia or R.)

[SciML](https://sciml.ai): a large ecosystem of packages for scientific machine learning. Includes Symbolics.jl, for doing symbolic mathematics in Julia.
...
Did you know that 1 slug (a unit of mass, used in the olden days) is that many kilograms? The Unitful package knows the values of hundreds of physical units from the SI and other systems, and you can even define your own!
